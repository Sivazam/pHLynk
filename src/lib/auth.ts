      ...
      async authorize(credentials) {
        ...
        try {
          ...
          try {
            ...
            secureLogger.auth('Firebase auth failed, trying retailer auth', { error: firebaseError instanceof Error ? firebaseError.message : 'Unknown error' });
            ...
            try {
              ...
              secureLogger.auth('Retailer auth also failed', { error: retailerError instanceof Error ? retailerError.message : 'Unknown error' });
            }
            
            return null
          }
        } catch (error) {
          secureLogger.error('Authorization error', { error: error instanceof Error ? error.message : 'Unknown error' });
          return null
        }
      }
    })
