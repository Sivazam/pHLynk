...
function getServiceAccountConfig() {
  ...
  const firebaseServiceAccount = {
    ...
    project_id: process.env.FIREBASE_SERVICE_ACCOUNT_PROJECT_ID || "plkapp-8c052",
    private_key_id: process.env.FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY_ID || "0b906bfeb55d289d9d14298301f4d0e05ba38a5a",
    private_key: process.env.FIREBASE_SERVICE_ACCOUNT_PRIVATE_KEY?.replace(/\\n/g, '\n') || "PLACEHOLDER_PRIVATE_KEY_HERE",
    client_email: process.env.FIREBASE_SERVICE_ACCOUNT_CLIENT_EMAIL || "firebase-adminsdk-fbsvc@plkapp-8c052.iam.gserviceaccount.com",
    client_id: process.env.FIREBASE_SERVICE_ACCOUNT_CLIENT_ID || "114562258379654978244",
    ...
    client_x509_cert_url: process.env.FIREBASE_SERVICE_ACCOUNT_CLIENT_X509_CERT_URL || "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40plkapp-8c052.iam.gserviceaccount.com",
