              ...
              {activeNav === 'overview' && (
                <div className="space-y-6">
                  ...
                  <div className="flex justify-end pb-0">
                    <DaySheet
                      payments={payments}
                      lineWorkers={user ? [{ id: user.uid, displayName: user.displayName || 'Me', assignedAreas: [], assignedZips: [], tenantId: 'system', email: user.email || '', role: 'line-worker', createdAt: Timestamp.now(), updatedAt: Timestamp.now() }] : []}
                      areas={areas}
                      retailers={retailers}
