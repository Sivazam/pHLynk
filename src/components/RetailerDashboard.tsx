...
export function RetailerDashboard() {
  ...
  const syncOTPsFromFirestore = async () => {
    ...
    try {
      ...
      console.error('❌ Error syncing OTPs from Firestore:', error);
    }
  };
