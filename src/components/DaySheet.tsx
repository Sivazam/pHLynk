...
export function DaySheet({
  ...
  const generateCSV = () => {
    ...
    const fileName = `DaySheet_${wholesalerBusinessName.replace(/\s+/g, '_')}_${formatTimestamp(dateRange.startDate)}.csv`;
                ...
                <Card>
                  <CardHeader className="flex flex-row items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Button onClick={generateCSV} variant="outline" className="flex items-center space-x-2">
